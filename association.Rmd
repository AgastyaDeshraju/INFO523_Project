...
```{r}
plot(satisfied_rules, method = "scatterplot", measure = c("support", "confidence"), shading = "lift")
...
plot(unsatisfaction_rules, method = "scatterplot", measure = c("support", "confidence"), shading = "lift")
```
```{r}
high_lift_unsatisfaction_rules <- subset(unsatisfaction_rules, lift > 1.5)
plot(high_lift_unsatisfaction_rules, method = "scatterplot", measure = c("support", "confidence"), shading = "lift")
