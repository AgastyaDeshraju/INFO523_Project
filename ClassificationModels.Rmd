...
Visualize how categorical features like Class or Customer Type relate to Satisfaction
...
6. Stacked Bar Chart for Categorical Features

```{r}
# Example: Customer Type and Satisfaction
